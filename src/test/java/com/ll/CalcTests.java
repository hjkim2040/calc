...
public class CalcTests {
    ...
    void t18() { assertThat(Calc.run("(10 + 20)")).isEqualTo(30); }
    @Test
    @DisplayName("((10 + 20)) == 30")
    void t19() { assertThat(Calc.run("((10 + 20))")).isEqualTo(30); }

    @Test
    @DisplayName("(((10 + 20))) == 30")
    void t20() { assertThat(Calc.run("(((10 + 20)))")).isEqualTo(30); }
    @Test
    @DisplayName("(20 + 20) + 20 == 60")
    void t21() { assertThat(Calc.run("(20 + 20) + 20")).isEqualTo(60); }

    @Test
    @DisplayName("((20 + 20)) + 20 == 60")
    void t22() { assertThat(Calc.run("((20 + 20)) + 20")).isEqualTo(60); }
    @Test
    @DisplayName("(10 + 20) * 3 == 90")
    void t23() { assertThat(Calc.run("(10 + 20) * 3")).isEqualTo(90); }
    @Test
    @DisplayName("10 + (10 + 5) == 25")
    void t24() { assertThat(Calc.run("10 + (10 + 5)")).isEqualTo(25); }
}
